...
public static class TodoEntpoints
{
    ...
    // get all todos
    // <snippet_1>
    public static async Task<Ok<Todo[]>> GetAllTodos(TodoDbContext database)
    {
    ...
    // create todo
    public static async Task<Created<Todo>> CreateTodo(TodoDto todo, TodoDbContext database)
    {
    ...
    // update todo
    public static async Task<Results<Created<Todo>, NotFound>> UpdateTodo(Todo todo, TodoDbContext database)
    {
